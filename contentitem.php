...
$returnurl = new \moodle_url('/mod/mcodelti/contentitem_return.php', $returnurlparams);

// Prepare the request.
$request = mcodelti_build_content_item_selection_request($id, $course, $returnurl, $title, $text, [], []);

// Get the launch HTML.
$content = mcodelti_post_launch_html($request->params, $request->url, false);
