...
Feature: Add preconfigured tools via teacher interface
  ...
  Scenario: Add a tool from a cartridge
    ...
    And I set the field "Tool URL" to local url "/mod/mcodelti/tests/fixtures/ims_cartridge_basic_mcodelti_link.xml"
    And I press "Save and return to course"
    And I open "Test tool activity 1" actions menu
    And I choose "Edit settings" in the open action menu
    And I expand all fieldsets
    Then the field "Tool URL" matches value "http://www.example.com/mcodelti/provider.php"
    And the field "Secure tool URL" matches value "https://www.example.com/mcodelti/provider.php"
  ...
  Scenario: Add and use a preconfigured tool
    ...
    And I open "Test tool activity 1" actions menu
    And I choose "Edit settings" in the open action menu
    And I set the field "Tool URL" to local url "/mod/mcodelti/tests/fixtures/tool_provider.php"
    And I press "Save and return to course"
