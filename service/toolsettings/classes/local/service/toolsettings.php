...
namespace mcodeltiservice_toolsettings\local\service;
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class toolsettings extends \mod_mcodelti\local\mcodeltiservice\service_base {
    ...
    public function get_resources() {
        ...
        if (empty($this->resources)) {
            ...
            $this->resources[] = new \mcodeltiservice_toolsettings\local\resource\systemsettings($this);
            $this->resources[] = new \mcodeltiservice_toolsettings\local\resource\contextsettings($this);
            $this->resources[] = new \mcodeltiservice_toolsettings\local\resource\linksettings($this);
        }
