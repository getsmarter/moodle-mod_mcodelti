 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class systemsettings extends \mod_mcodelti\local\mcodeltiservice\resource_base {

    /**
     * Class constructor.
     *
     * @param mcodeltiservice_toolsettings\local\service\toolsettings $service Service instance
     */
    ...
    public function execute($response) {
        ...
        if ($ok) {
            ...
            if ($response->get_request_method() == 'GET') {
                ...
                if ($ok) {
                    mcodelti_set_tool_settings($settings, $this->get_service()->get_tool_proxy()->id);
                } else {
                    $response->set_code(406);
                }
            }
