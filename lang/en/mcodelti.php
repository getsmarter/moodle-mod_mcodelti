...
/**
 * This file contains en_utf8 translation of the Basic mcodelti module
 *
...
$string['basicmcodelti'] = 'mcodelti';
$string['basicmcodelti_base_string'] = 'mcodelti OAuth base string';
$string['basicmcodelti_endpoint'] = 'mcodelti launch endpoint';
$string['basicmcodelti_in_new_window'] = 'Your activity has opened in a new window';
$string['basicmcodelti_in_new_window_open'] = 'Open in new window';
$string['basicmcodelti_parameters'] = 'mcodelti launch parameters';
$string['basicmcodeltiactivities'] = 'mcodelti activities';
$string['basicmcodeltifieldset'] = 'Custom example fieldset';
$string['basicmcodeltiintro'] = 'Activity description';
$string['basicmcodeltiname'] = 'Activity name';
$string['basicmcodeltisettings'] = 'Basic Learning Tool Interoperability (mcodelti) settings';
...
$string['configtypes'] = 'Enable mcodelti applications';
...
$string['curllibrarymissing'] = 'PHP Curl library must be installed to use mcodelti';
...
$string['errortooltypenotfound'] = 'mcodelti tool type not found.';
$string['existing_window'] = 'Existing window';
$string['extensions'] = 'mcodelti extension services';
...
$string['filter_basicmcodelti_configlink'] = 'Configure your preferred sites and their passwords';
$string['filter_basicmcodelti_password'] = 'Password is mandatory';
$string['filterconfig'] = 'mcodelti administration';
$string['filtername'] = 'mcodelti';
...
mcodelti icon, an icon which conveys the type of activity may be specified.';
$string['id'] = 'ID';
$string['indicator:cognitivedepth'] = 'mcodelti cognitive';
$string['indicator:cognitivedepth_help'] = 'This indicator is based on the cognitive depth reached by the student in an mcodelti activity.';
$string['indicator:socialbreadth'] = 'mcodelti social';
$string['indicator:socialbreadth_help'] = 'This indicator is based on the social breadth reached by the student in an mcodelti activity.';
$string['invalidid'] = 'mcodelti ID was incorrect';
...
$string['mcodelti'] = 'mcodelti';
$string['mcodelti:addinstance'] = 'Add new external tool activities';
$string['mcodelti:addcoursetool'] = 'Add course-specific tool configurations';
$string['mcodelti:grade'] = 'View grades returned by the external tool';
$string['mcodelti:manage'] = 'Be an Instructor when the tool is launched';
$string['mcodelti:admin'] = 'Be an administrator when the tool is launched';
$string['mcodelti:requesttooladd'] = 'Request a tool is configured site-wide';
$string['mcodelti:view'] = 'Launch external tool activities';
$string['mcodeltisettings'] = 'mcodelti settings';
$string['mcodelti_administration'] = 'Edit preconfigured tool';
$string['mcodelti_errormsg'] = 'The tool returned the following error message: "{$a}"';
$string['mcodelti_launch_error'] = 'An error occurred when launching the external tool:';
$string['mcodelti_launch_error_tool_request'] = '<p>
...
$string['mcodelti_launch_error_unsigned_help'] = '<p>This error may be a result of a missing consumer key and shared secret for the tool provider.</p>
...
$string['mcodelti_tool_request_added'] = 'Tool configuration request successfully submitted. You may need to contact an administrator to complete the tool configuration.';
$string['mcodelti_tool_request_existing'] = 'A tool configuration for the tool domain has already been submitted.';
$string['mcodeltiunknownserviceapicall'] = 'mcodelti unknown service API call.';
...
To create an external tool activity, a tool provider which supports mcodelti (Learning Tools Interoperability) is required. A teacher can create an external tool activity or make use of a tool configured by the site administrator.
...
$string['modulename_link'] = 'mod/mcodelti/view';
$string['modulename_shortcut_link'] = 'mod/mcodelti/view/custom';
$string['modulenameplural'] = 'External tools';
$string['modulenamepluralformatted'] = 'mcodelti Instances';
$string['name'] = 'Name';
$string['never'] = 'Never';
$string['new_window'] = 'New window';
$string['no_mcodelti_configured'] = 'There are no active external tools configured.';
$string['no_mcodelti_pending'] = 'There are no pending external tools.';
$string['no_mcodelti_rejected'] = 'There are no rejected external tools.';
$string['no_mcodelti_tools'] = 'There are no external tools configured.';
...
$string['nomcodeltis'] = 'There are no external tool instances';
$string['noprofileservice'] = 'Profile service not found';
$string['noservers'] = 'No servers found';
$string['notypes'] = 'There are currently no mcodelti tools set up in Moodle. Click the Install link above to add some.';
...
$string['quickgrade_help'] = 'If enabled, mumcodeltiple tools can be graded on one page. Add grades and comments then click the "Save all my feedback" button to save all changes for that page.';
...
$string['show_in_course_mcodelti1'] = 'Tool configuration usage';
$string['show_in_course_mcodelti1_help'] = 'This tool may be shown in the activity chooser for a teacher to select to add to a course. Alternatively, it may be shown in the preconfigured tool dropdown menu when adding an external tool to a course. A further option is for the tool configuration to only be used if the exact tool URL is entered when adding an external tool to a course.';
$string['show_in_course_mcodelti2'] = 'Tool configuration usage';
$string['show_in_course_mcodelti2_help'] = 'This tool can be shown in the activity chooser for a teacher to select to add to a course or in the preconfigured tool dropdown menu when adding an external tool to a course.';
...
$string['subplugintype_mcodeltiresource'] = 'mcodelti service resource';
$string['subplugintype_mcodeltiresource_plural'] = 'mcodelti service resources';
$string['subplugintype_mcodeltiservice'] = 'mcodelti service';
$string['subplugintype_mcodeltiservice_plural'] = 'mcodelti services';
$string['subplugintype_mcodeltisource'] = 'mcodelti source';
$string['subplugintype_mcodeltisource_plural'] = 'mcodelti sources';
