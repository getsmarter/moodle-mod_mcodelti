...
$functions = array(
    ...
    'mod_mcodelti_get_tool_launch_data' => array(
        'classname'     => 'mod_mcodelti_external',
        'methodname'    => 'get_tool_launch_data',
        'description'   => 'Return the launch data for a given external tool.',
        'type'          => 'read',
        'capabilities'  => 'mod/mcodelti:view',
        'services'      => array(MOODLE_OFFICIAL_MOBILE_SERVICE)
    ),

    'mod_mcodelti_get_mcodeltis_by_courses' => array(
        'classname'     => 'mod_mcodelti_external',
        'methodname'    => 'get_mcodeltis_by_courses',
    ...
    'mod_mcodelti_view_mcodelti' => array(
        'classname'     => 'mod_mcodelti_external',
        'methodname'    => 'view_mcodelti',
    ...
    'mod_mcodelti_get_tool_proxies' => array(
        'classname'     => 'mod_mcodelti_external',
    ...
    'mod_mcodelti_create_tool_proxy' => array(
        'classname'     => 'mod_mcodelti_external',
    ...
    'mod_mcodelti_delete_tool_proxy' => array(
        'classname'     => 'mod_mcodelti_external',
    ...
    'mod_mcodelti_get_tool_proxy_registration_request' => array(
        'classname'     => 'mod_mcodelti_external',
    ...
    'mod_mcodelti_get_tool_types' => array(
        'classname'     => 'mod_mcodelti_external',
    ...
    'mod_mcodelti_create_tool_type' => array(
        'classname'     => 'mod_mcodelti_external',
    ...
    'mod_mcodelti_update_tool_type' => array(
        'classname'     => 'mod_mcodelti_external',
    ...
    'mod_mcodelti_delete_tool_type' => array(
        'classname'     => 'mod_mcodelti_external',
    ...
    'mod_mcodelti_is_cartridge' => array(
        'classname'     => 'mod_mcodelti_external',
