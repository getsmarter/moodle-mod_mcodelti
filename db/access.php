...
/**
 * This file contains the capabilities used by the mcodelti module
 *
...
$capabilities = array(
    ...
    'mod/mcodelti:addinstance' => array(
    ...
    // otherwise they are given Learner. See the mcodelti_get_ims_role function.
    'mod/mcodelti:manage' => array(
    ...
    'mod/mcodelti:addcoursetool' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
            'editingteacher' => CAP_ALLOW,
    ...
    'mod/mcodelti:requesttooladd' => array(
        'captype' => 'write',
        'contextlevel' => CONTEXT_COURSE,
        'archetypes' => array(
            'editingteacher' => CAP_ALLOW,
