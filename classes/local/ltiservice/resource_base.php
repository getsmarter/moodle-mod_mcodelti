...
/**
 * This file contains an abstract definition of an mcodelti resource
 *
...
/**
 * The mod_mcodelti\local\mcodeltiservice\resource_base class.
 *
 * @package    mod_mcodelti
 * @since      Moodle 2.8
 * @copyright  2014 Vital Source Technologies http://vitalsource.com
...
abstract class resource_base {
     ...
     * Class constructor.
     *
     * @param mod_mcodelti\local\mcodeltiservice\service_base $service Service instance
     */
     ...
     *
     * @return mod_mcodelti\local\mcodeltiservice\service_base
     */
        ...
        if ($this->get_service()->check_tool_proxy($toolproxyguid, $body)) {
            ...
            if (empty($toolproxyjson)) {
                ...
                if (!empty($toolproxy) && isset($toolproxy->security_contract->tool_service)) {
                    $contexts = mcodelti_get_contexts($toolproxy);
