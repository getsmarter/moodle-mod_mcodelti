...
/**
 * The mod_mcodelti unknown service api called event.
 *
...
namespace mod_mcodelti\event;
defined('MOODLE_INTERNAL') || die();

/**
 * The mod_mcodelti unknown service api called event class.
 *
 * Event for when something happens with an unknown mcodelti service API call.
 *
 * @package    mod_mcodelti
 * @since      Moodle 2.6
 * @copyright  2013 Adrian Greeve <adrian@moodle.com>
...
class unknown_service_api_called extends \core\event\base {
    ...
    public static function get_name() {
        return get_string('mcodeltiunknownserviceapicall', 'mod_mcodelti');
    }
    ...
    public static function get_legacy_eventname() {
        return 'mcodelti_unknown_service_api_call';
    }
