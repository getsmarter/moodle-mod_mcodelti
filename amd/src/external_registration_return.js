 ...
 *
 * See also: mod/mcodelti/externalregistrationreturn.php
 *
 * @module     mod_mcodelti/external_registration_return
...
define([], function() {
    ...
    return /** @alias module:mod_mcodelti/external_registration_return */ {
