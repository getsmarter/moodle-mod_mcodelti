 ...
 *
 * See template: mod_mcodelti/tool_proxy_card
 *
 * @module     mod_mcodelti/tool_proxy_card_controller
 ...
 * @since      3.1
 */
define(['jquery', 'core/ajax', 'core/notification', 'core/templates', 'mod_mcodelti/tool_proxy', 'mod_mcodelti/events', 'mod_mcodelti/keys',
        'core/str'],
        function($, ajax, notification, templates, toolProxy, mcodeltiEvents, KEYS, str) {
    ...
    var activateToolType = function(element) {
        ...
        $(document).trigger(mcodeltiEvents.START_EXTERNAL_REGISTRATION, data);
    };
