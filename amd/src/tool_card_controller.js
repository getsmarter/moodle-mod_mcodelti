 ...
 * listed on the mcodelti tool type management page.
 *
 * See template: mod_mcodelti/tool_card
 *
 * @module     mod_mcodelti/tool_card_controller
 ...
 * @since      3.1
 */
define(['jquery', 'core/ajax', 'core/notification', 'core/templates', 'mod_mcodelti/tool_type', 'mod_mcodelti/events', 'mod_mcodelti/keys',
        'core/str'],
        function($, ajax, notification, templates, toolType, mcodeltiEvents, KEYS, str) {
    ...
    var setStatusActive = function(element) {
        ...
        promise.then(function(toolTypeData) {
            ...
            return templates.render('mod_mcodelti/tool_card', toolTypeData);
    ...
    var registerEventListeners = function(element) {
        ...
        if (hasCapabilitiesContainer(element)) {
            ...
            capabilitiesContainer.on(mcodeltiEvents.CAPABILITIES_AGREE, function() {
                setStatusActive(element);
            });

            capabilitiesContainer.on(mcodeltiEvents.CAPABILITIES_DECLINE, function() {
                hideCapabilitiesApproval(element);
            });
        }
    };

    return /** @alias module:mod_mcodelti/tool_card_controller */ {
