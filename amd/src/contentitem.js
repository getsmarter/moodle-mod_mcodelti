 ...
 * mcodelti tool provider that supports Content-Item type message.
 *
 * See template: mod_mcodelti/contentitem
 *
 * @module     mod_mcodelti/contentitem
 * @class      contentitem
    ...
    function($, notification, str, templates, FormField, ModalFactory, ModalEvents) {
        ...
        var contentItem = {
            ...
            init: function(url, postData) {
                ...
                var bodyPromise = templates.render('mod_mcodelti/contentitem', context);
                ...
                str.get_string('selectcontent', 'mcodelti').then(function(title) {
        ...
        /**
         * Array of form fields for mcodelti tool configuration.
         *
         * @type {*[]}
         */
        var mcodeltiFormFields = [
        ...
        /**
         * Window function that can be called from mod_mcodelti/contentitem_return to close the dialogue and process the return data.
         *
        ...
        window.processContentItemReturnData = function(returnData) {
            ...
            // Populate mcodelti configuration fields from return data.
            var index;
            for (index in mcodeltiFormFields) {
                var field = mcodeltiFormFields[index];
                var value = null;
